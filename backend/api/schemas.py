...
class ChatTTSResponse(BaseModel):
    ...
    action: Optional[str] = Field(default=None, description="兼容旧协议的动作标签")
    legacy_action: Optional[str] = Field(default=None, description="旧动作别名，例如 wave / angry")
    motion_category: Optional[str] = Field(default=None, description="动作类别，例如 idle / dance / fight")
    motion_intensity: Optional[str] = Field(default=None, description="动作强度，例如 low / medium / high")
    expression: Optional[str] = Field(default=None, description="表情名，例如 happy / surprised")
    expression_intensity: Optional[str] = Field(default=None, description="表情强度，例如 low / medium / high")
