...
const checks = [
  ...
  },
  {
    ...
    evidence: [
      ...
      ev('HumanClaw update_plan tool definition', human.toolRuntime, ["id: 'update_plan'", 'HumanClawRuntimeTool', 'definitionById.update_plan']),
  ...
  },
  {
    ...
    evidence: [
      ...
      ev('HumanClaw MCP runtime bridge surface', human.toolRuntime, ["id: 'mcp_bridge'", 'dispatchDirectMcpTool', 'tool_search']),
  ...
  },
  {
    ...
    evidence: [
      ...
      ev('HumanClaw subagent runtime definition', human.toolRuntime, ["id: 'subagents'", 'definitionById.subagents']),
